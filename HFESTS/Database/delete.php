  ...
  if ($_GET['table_name'] == 'Employees_Managers') {
    ...
    $URLpath = "../Employees_Managers/E_Delete.php";
    ...
    $URLpath = "../Vaccination/V_Delete.php";
    ...
    $URLpath = "../Infection/I_Delete.php";
